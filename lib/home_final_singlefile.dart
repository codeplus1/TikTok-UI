...
import 'package:tiktik_tackletalent/tiktik_icons.dart';
  ...
  Widget get actionsToolbar => Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _getVideoAction(title: '350.2M', icon: TikTokIcons.heart),
            _getVideoAction(title: '300.5M', icon: TikTokIcons.chat_bubble),
            _getVideoAction(
